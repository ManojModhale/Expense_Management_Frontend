...
import { getExpensesByManager } from "../../services/expenseService";
    ...
    const fetchExpenses = useCallback(async () => {
        ...
        try {
            ...
            if (!username) {
                ...
                Notification.error("Manager not logged in.");
                return;
            }
            const response = await getExpensesByManager(username);
           ...
           {/* Recent Expenses and Category Chart */}
              ...
              {recentExpenses.length > 0 && (
                <Paper elevation={2} className="dashboard-section recent-activity-card">
                  ...
                  <div style={{ textAlign: 'center', marginTop: 16 }}>
                    <Button component={Link} to="/manager/my-expense" variant="outlined" color="primary">
                      View All Expenses
                    </Button>
                  </div>
                </Paper>
            ...
            <div className="dashboard-section policy-links">
              ...
              <List dense>
                <ListItem>
                  <ListItemText>
                    <Link to="/manager/expense-policy">Company Expense Policy</Link>
                  </ListItemText>
                </ListItem>
                <ListItem>
                  <ListItemText>
                    <Link to="/manager/faq">Expense Management FAQ</Link>
                  </ListItemText>
                </ListItem>
